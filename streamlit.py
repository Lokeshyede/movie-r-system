...
st.markdown(
     """
<style>
    /* Professional Font & Global Reset */
    ...
    .card { 
        ...
        border-radius: 16px; 
        padding: 0; /* Changed to 0 to allow image to touch edges */
        background: #ffffff; 
        transition: all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1);
        cursor: pointer;
    }

    /* Image Placeholder / Poster area */
    .card-image {
        width: 100%;
        height: 200px;
        background: #cbd5e1;
    ...
    .card:hover {
        ...
        border-color: #3b82f6; /* Subtle blue highlight */
    }
